...
│   │   ├── BackgroundGradient.tsx  # Animated background gradient component
│   │   ├── DataFetchWrapper.tsx    # Data fetching wrapper with loading states
...
│   │   ├── cursor/              # Cursor tracking components
│   │   ├── extensionAuth/       # Extension auth components
...
│   └── InitializeReusableChunks.tsx  # Library initialization component
...
8. **AI Elements** - https://elements.ai-sdk.dev
   - AI-native components built on shadcn/ui for AI SDK
   - Focus: Chat, code, voice, workflow components for AI applications
   - Registry: `@ai-elements` namespace configured

9. **8StarLabs UI** - https://ui.8starlabs.com
   - Niche, purpose-built components (flip clock, heatmap, timeline)
   - Focus: Specialized data visualization and display components
   - Install: `npx shadcn@latest add https://ui.8starlabs.com/r/{name}.json`
